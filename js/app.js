...
//         prevPageBtn.addEventListener('click', () => handlePageChange(0));
//     }else{
...
// };
        ...
        //         return;
        //     }
        //     const images = await searchImages(termino);
...
//         caption.textContent = `Autor: ${author}, Vistas: ${views}`;
...
// }
        ...
        // async function searchImages(termino) {
        //     const accessKey = '7y-Jo9zPZ6JN8lSubmNDA5pfvAlm5SZtfxql3v_Nsb4'; // ¡Recuerda reemplazar esto con tu clave de acceso!
        //     const apiUrl = `https://api.unsplash.com/search/photos?query=${termino}&per_page=10&client_id=${accessKey}`;
        //     try {
        //         const response = await fetch(apiUrl);
        //         const data = await response.json();
        //         return data.results;
